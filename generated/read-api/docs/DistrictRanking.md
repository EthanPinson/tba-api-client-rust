...
**event_points** | [**Vec<models::DistrictRankingEventPointsInner>**](DistrictRankingEventPointsInner.md) | List of events that contributed to the point total for the team. | 
