...
**sort_order_info** | Option<[**Vec<models::EventRankingSortOrderInfoInner>**](Event_Ranking_sort_order_info_inner.md)> | List of year-specific values provided in the `sort_orders` array for each team. | 
