...
**event_type** | **i32** | Event Type, as defined here: https://github.com/the-blue-alliance/the-blue-alliance/blob/main/src/backend/common/consts/event_type.py#L8 | 
...
**gmaps_place_id** | Option<**String**> | Google Maps Place ID for the event address. Will be NULL, for future development. | 
**gmaps_url** | Option<**String**> | Link to address location on Google Maps. Will be NULL, for future development. | 
**lat** | Option<**f64**> | Latitude for the event address. Will be NULL, for future development. | 
**lng** | Option<**f64**> | Longitude for the event address. Will be NULL, for future development. | 
**location_name** | Option<**String**> | Name of the location at the address for the event, eg. Blue Alliance High School. | 
**timezone** | Option<**String**> | IANA Timezone identifier. | 
...
**playoff_type** | Option<**i32**> | Playoff Type, as defined under `PlayoffType`: https://github.com/the-blue-alliance/the-blue-alliance/blob/main/src/backend/common/consts/playoff_type.py#L37, or null. | 
