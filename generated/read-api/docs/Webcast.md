...
------------ | ------------- | ------------- | -------------
**r#type** | **Type** | Type of webcast, typically descriptive of the streaming provider. (enum: youtube, twitch, ustream, iframe, html5, rtmp, livestream, direct_link, mms, justin, stemtv, dacast) | 
