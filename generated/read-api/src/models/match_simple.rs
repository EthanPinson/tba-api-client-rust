...
impl MatchSimple {
    pub fn new(key: String, comp_level: models::CompLevel, set_number: i32, match_number: i32, alliances: models::MatchAlliances, winning_alliance: WinningAlliance, event_key: String, time: Option<i64>, predicted_time: Option<i64>, actual_time: Option<i64>) -> MatchSimple {
        MatchSimple {
            key,
            comp_level,
            set_number,
