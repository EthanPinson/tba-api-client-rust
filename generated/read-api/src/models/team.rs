...
pub struct Team {
    ...
    #[serde(rename = "motto", deserialize_with = "Option::deserialize")]
    pub motto: Option<String>,
}

impl Team {
    pub fn new(key: String, team_number: i32, nickname: String, name: String, school_name: Option<String>, city: Option<String>, state_prov: Option<String>, country: Option<String>, address: Option<String>, postal_code: Option<String>, gmaps_place_id: Option<String>, gmaps_url: Option<String>, lat: Option<f64>, lng: Option<f64>, location_name: Option<String>, website: Option<String>, rookie_year: Option<i32>, motto: Option<String>) -> Team {
        Team {
            key,
            team_number,
            nickname,
