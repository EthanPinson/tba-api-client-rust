...
pub struct ApiStatus {
    ...
    #[serde(rename = "max_team_page")]
    pub max_team_page: i32,
}

impl ApiStatus {
    pub fn new(current_season: i32, max_season: i32, is_datafeed_down: bool, down_events: Vec<String>, ios: models::ApiStatusAppVersion, android: models::ApiStatusAppVersion, max_team_page: i32) -> ApiStatus {
        ApiStatus {
            current_season,
            max_season,
            is_datafeed_down,
