...
pub struct Event {
    ...
    pub district: Box<models::District>,
    ...
    #[serde(rename = "remap_teams")]
    pub remap_teams: std::collections::HashMap<String, String>,
}

impl Event {
    pub fn new(key: String, name: String, event_code: String, event_type: i32, district: models::District, city: Option<String>, state_prov: Option<String>, country: Option<String>, start_date: String, end_date: String, year: i32, short_name: Option<String>, event_type_string: String, week: Option<i32>, address: Option<String>, postal_code: Option<String>, gmaps_place_id: Option<String>, gmaps_url: Option<String>, lat: Option<f64>, lng: Option<f64>, location_name: Option<String>, timezone: Option<String>, website: Option<String>, first_event_id: Option<String>, first_event_code: Option<String>, webcasts: Vec<models::Webcast>, division_keys: Vec<String>, parent_event_key: Option<String>, playoff_type: Option<i32>, playoff_type_string: Option<String>, remap_teams: std::collections::HashMap<String, String>) -> Event {
        Event {
            key,
            name,
            event_code,
            event_type,
            district: Box::new(district),
            city,
            state_prov,
            country,
            start_date,
