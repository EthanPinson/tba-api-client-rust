...
/// struct for typed errors of method [`get_district_dcmp_history`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetDistrictDcmpHistoryError {
    Status401(models::InlineObject),
    Status404(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`get_district_insights`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetDistrictInsightsError {
    Status401(models::InlineObject),
    Status404(),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_district_dcmp_history(configuration: &configuration::Configuration, district_abbreviation: &str, if_none_match: Option<&str>) -> Result<Vec<models::GetDistrictDcmpHistory200ResponseInner>, Error<GetDistrictDcmpHistoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_district_abbreviation = district_abbreviation;
    let p_header_if_none_match = if_none_match;

    let uri_str = format!("{}/district/{district_abbreviation}/dcmp_history", configuration.base_path, district_abbreviation=crate::apis::urlencode(p_path_district_abbreviation));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::GetDistrictDcmpHistory200ResponseInner&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::GetDistrictDcmpHistory200ResponseInner&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetDistrictDcmpHistoryError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_district_history(configuration: &configuration::Configuration, district_abbreviation: &str, if_none_match: Option<&str>) -> Result<Vec<models::District>, Error<GetDistrictHistoryError>> {
    ...
    let uri_str = format!("{}/district/{district_abbreviation}/history", configuration.base_path, district_abbreviation=crate::apis::urlencode(p_path_district_abbreviation));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::District&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::District&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_district_insights(configuration: &configuration::Configuration, district_abbreviation: &str, if_none_match: Option<&str>) -> Result<models::DistrictInsight, Error<GetDistrictInsightsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_district_abbreviation = district_abbreviation;
    let p_header_if_none_match = if_none_match;

    let uri_str = format!("{}/district/{district_abbreviation}/insights", configuration.base_path, district_abbreviation=crate::apis::urlencode(p_path_district_abbreviation));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DistrictInsight`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DistrictInsight`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetDistrictInsightsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_districts_by_year(configuration: &configuration::Configuration, year: i32, if_none_match: Option<&str>) -> Result<Vec<models::District>, Error<GetDistrictsByYearError>> {
    ...
    let uri_str = format!("{}/districts/{year}", configuration.base_path, year=p_path_year);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
