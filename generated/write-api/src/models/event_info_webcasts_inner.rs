...
/// EventInfoWebcastsInner : A webcast object
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventInfoWebcastsInner {
    /// A webcast url
    #[serde(rename = "url", skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
}

impl EventInfoWebcastsInner {
    /// A webcast object
    pub fn new() -> EventInfoWebcastsInner {
        EventInfoWebcastsInner {
            url: None,
        }
    }
}
