...
/// EventInfoDisableSync : flags controlling disabling certain aspects of sync
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EventInfoDisableSync {
    #[serde(rename = "event_alliances", skip_serializing_if = "Option::is_none")]
    pub event_alliances: Option<bool>,
    #[serde(rename = "event_rankings", skip_serializing_if = "Option::is_none")]
    pub event_rankings: Option<bool>,
    #[serde(rename = "event_qual_matches", skip_serializing_if = "Option::is_none")]
    pub event_qual_matches: Option<bool>,
    #[serde(rename = "event_playoff_matches", skip_serializing_if = "Option::is_none")]
    pub event_playoff_matches: Option<bool>,
    #[serde(rename = "event_awards", skip_serializing_if = "Option::is_none")]
    pub event_awards: Option<bool>,
}

impl EventInfoDisableSync {
    /// flags controlling disabling certain aspects of sync
    pub fn new() -> EventInfoDisableSync {
        EventInfoDisableSync {
            event_alliances: None,
            event_rankings: None,
            event_qual_matches: None,
            event_playoff_matches: None,
            event_awards: None,
        }
    }
}
