...
*EventWebcastsApi* | [**add_event_webcasts**](docs/EventWebcastsApi.md#add_event_webcasts) | **PATCH** /event/{eventKey}/webcasts/update | Add webcasts to an event
*EventWebcastsApi* | [**delete_event_webcasts**](docs/EventWebcastsApi.md#delete_event_webcasts) | **DELETE** /event/{eventKey}/webcasts/update | Remove webcasts from an event
...
## Documentation For Models
 ...
 - [WebcastUpdate](docs/WebcastUpdate.md)
