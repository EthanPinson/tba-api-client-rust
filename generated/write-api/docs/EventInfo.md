...
**webcasts** | Option<[**Vec<models::EventInfoWebcastsInner>**](EventInfoWebcastsInner.md)> | A list of webcast URLs to set for this event. This will overwrite the existing webcast list | [optional]
...
**disable_sync** | Option<[**models::EventInfoDisableSync**](EventInfoDisableSync.md)> |  | [optional]
